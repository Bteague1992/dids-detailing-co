...
const cityMotoIntros: Record<string, string> = {
  hickory: `Dad's Mobile Detailing Co. is based right here in Hickory, NC — so when you book a motorcycle detail, you get fast, local service from someone who knows the area. We come to wherever your bike is parked with everything needed to make it shine. Basic wash starts at $${motorcycleBasicWashPrice}, full detail at $${motorcycleFullDetailPrice}. Text us to book today.`,
  newton: `Dad's Mobile Detailing Co. brings professional motorcycle detailing directly to Newton, NC — no drop-off required. We come to you in Catawba County whether you ride a cruiser, sport bike, or touring bike. Basic wash starts at $${motorcycleBasicWashPrice}, full detail at $${motorcycleFullDetailPrice}. Text us to book your motorcycle detail today.`,
  morganton: `Dad's Mobile Detailing Co. brings professional motorcycle detailing directly to Morganton, NC — no drop-off required. We travel to Burke County to detail your bike wherever it's parked, with everything needed for a thorough clean and shine. Basic wash starts at $${motorcycleBasicWashPrice}, full detail at $${motorcycleFullDetailPrice}. Text us to book today.`,
  lenoir: `Dad's Mobile Detailing Co. brings professional motorcycle detailing directly to Lenoir, NC — no drop-off required. We come to you in Caldwell County to detail your bike on your schedule. Basic wash starts at $${motorcycleBasicWashPrice}, full detail at $${motorcycleFullDetailPrice}. Text us to book your motorcycle detail today.`,
};
...
const DEFAULT_MOTO_INTRO = (cityName: string) =>
  `Dad's Mobile Detailing Co. brings professional motorcycle detailing directly to ${cityName}, NC — no drop-off required. Whether you ride a cruiser, sport bike, or touring bike, we come to wherever your bike is parked with everything needed to make it shine. Basic wash starts at $${motorcycleBasicWashPrice}, full detail at $${motorcycleFullDetailPrice}. Text us to book your motorcycle detail today.`;
...
export function generateMotorcycleCityMetaDescription(
  ...
  return `Mobile motorcycle detailing in ${city.name}, NC starting at $${motorcycleBasicWashPrice}. We come to you — no drop-off needed. Basic wash & full detail available. Text to book today.`;
}
